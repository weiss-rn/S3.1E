...
-- If the table already exists without `category`, add it safely (MySQL/MariaDB).
...
SET @alter_sql := IF(
    ...
    'ALTER TABLE products ADD COLUMN category VARCHAR(50) NOT NULL DEFAULT ''semua'' AFTER name',
    'SELECT 1'
);
